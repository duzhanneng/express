...
export class _LIKE_UTIL {
    ...
    innerScrollPrevent() {
        ...
        return {
            afterOpen() {
                that._innerScrollPreventScrollTop = document.documentElement.scrollTop || document.body.scrollTop;

                document.body.style.position = 'fixed';
                document.body.style.width = '100%';
                document.body.style.height = '100%';

                document.body.style.top = -that._innerScrollPreventScrollTop + 'px';
            },
            beforeClose() {
                document.body.style.position = 'static';
                document.body.style.width = 'auto';
                document.documentElement.scrollTop = document.body.scrollTop = that._innerScrollPreventScrollTop;
            }
        };
    }
